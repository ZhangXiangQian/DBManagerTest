...
import org.android.zxq.db.converter.ColumnConverter;
import org.android.zxq.db.converter.ColumnConverterFactory;
    ...
    static Method findGetMethod(Class<?> entityType, Field field) {
        ...
        if (getMethod == null) {
            ...
            try {
                ...
                LogUtil.d(entityType.getName() + "#" + methodName + " not exist",e);
            }
        }
